...
% p*X 才是投影结果
% Performing principal compones analysis on the N1-by-N2 real-valued
...
elseif N < 1 || N > nr || round(N)~=N
    fprintf('Input N=%g is not valid; all components will be retained./n', N)
    N = nr;
end
